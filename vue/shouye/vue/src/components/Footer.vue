  ...
  <div>
    <div class="footer">
      <div class="layout">
        ...
        <a href="#">
          <img v-bind:src="footerImg.img" :title="footerImg.title" />
        </a>
      </div>
        <div class="slogan">
          <ul>
  ...
  data() {
    return {
       footerImg: {
        title: "新人频道",
        img:
          "https://res.vmallres.com/pimages//sale/2019-01/awBg2nLycya1sSIX1juQ.jpg",
      },
      baiqiang: [
...
<style scoped>
@import url("../static/css/footer1.css");
</style>
